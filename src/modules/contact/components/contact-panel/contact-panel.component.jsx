...
import {
  ...
  SocialNetworks,
  Item,
} from "./contact-panel.styles";

const ContactPanel = ({ postSendEmail = () => null }) => {
  ...
  const onFinish = async (fields) => {
    ...
    if (response) Notification("success", "Email enviado com sucesso!");
    else Notification("fail", response);
  };
    ...
    <ContactPanelStyles>
      <Row gutter={[1, 12]} style={{ width: "100%" }}>
        <Col
          ...
          xxl={{ span: 9 }}
        >
          <Panel style={{ borderRight: "1px solid rgba(219, 214, 209,0.1)", height: "90%" }}>
            <h2>Our contacts</h2>
            <SocialNetworks>
              <Item>
                <WhatsAppOutlined />
                <span style={{ fontSize: "14px" }}>+55 19 999379949</span>
              </Item>
              <Item>
                <PhoneOutlined />
                <span style={{ fontSize: "14px" }}>+55 19 33623383</span>
              </Item>
              <Item>
                <MailOutlined />
                <span style={{ fontSize: "14px" }}>wesley9983@gmail.com</span>
              </Item>
            </SocialNetworks>
          </Panel>
        </Col>
